...
public class DLAppServiceSoapServiceLocator extends org.apache.axis.client.Service implements edu.jhu.cvrg.liferay.portlet.documentlibrary.service.http.DLAppServiceSoapService {
    ...
    private java.lang.String Portlet_DL_DLAppService_address = "http://127.0.0.1:8080/api/secure/axis/Portlet_DL_DLAppService";
    ...
    public edu.jhu.cvrg.liferay.portlet.documentlibrary.service.http.DLAppServiceSoap getPortlet_DL_DLAppService() throws javax.xml.rpc.ServiceException {
    ...
    public edu.jhu.cvrg.liferay.portlet.documentlibrary.service.http.DLAppServiceSoap getPortlet_DL_DLAppService(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            edu.jhu.cvrg.liferay.portlet.documentlibrary.service.http.Portlet_DL_DLAppServiceSoapBindingStub _stub = new edu.jhu.cvrg.liferay.portlet.documentlibrary.service.http.Portlet_DL_DLAppServiceSoapBindingStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (edu.jhu.cvrg.liferay.portlet.documentlibrary.service.http.DLAppServiceSoap.class.isAssignableFrom(serviceEndpointInterface)) {
                edu.jhu.cvrg.liferay.portlet.documentlibrary.service.http.Portlet_DL_DLAppServiceSoapBindingStub _stub = new edu.jhu.cvrg.liferay.portlet.documentlibrary.service.http.Portlet_DL_DLAppServiceSoapBindingStub(new java.net.URL(Portlet_DL_DLAppService_address), this);
                _stub.setPortName(getPortlet_DL_DLAppServiceWSDDServiceName());
                return _stub;
            }
        }
