...
public class DLAppServiceSoapProxy implements edu.jhu.cvrg.liferay.portlet.documentlibrary.service.http.DLAppServiceSoap {
  private String _endpoint = null;
  private edu.jhu.cvrg.liferay.portlet.documentlibrary.service.http.DLAppServiceSoap dLAppServiceSoap = null;
  ...
  private void _initDLAppServiceSoapProxy() {
    try {
      dLAppServiceSoap = (new edu.jhu.cvrg.liferay.portlet.documentlibrary.service.http.DLAppServiceSoapServiceLocator()).getPortlet_DL_DLAppService();
  ...
  public edu.jhu.cvrg.liferay.portlet.documentlibrary.service.http.DLAppServiceSoap getDLAppServiceSoap() {
    if (dLAppServiceSoap == null)
      _initDLAppServiceSoapProxy();
